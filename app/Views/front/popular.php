        ...
        <div id="mainCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                    <img src="https://image.tmdb.org/t/p/original/cfT29Im5VDvjE0RpyKOSdCKZal7.jpg" class="d-block w-100" alt="Banner 1">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="https://image.tmdb.org/t/p/original/gILte6Zd7m1YneIr6MVhh30S9pr.jpg" class="d-block w-100" alt="Banner 2">
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="https://image.tmdb.org/t/p/original/dZklTql88IDOmkC3JAYQSTgyK6f.jpg" class="d-block w-100" alt="Banner 3">
                </div>
            </div>
        </div>
        <div class="hero-content">
            <h1>Disfruta de las mejores películas y series</h1>
            <p>Streaming ilimitado. Sin anuncios.</p>
            <a href="#" class="btn-hero">Comenzar ahora</a>
        </div>
    </section>

    <!-- seccion del contenido destacado -->
                ...
                <div class="movie-grid">
                    ...
                    <div class="movie-card">
                        <div class="movie-cover">
                            ...
                            <div class="movie-rating"><i class="fas fa-star"></i> 9.9</div>
                        </div>
